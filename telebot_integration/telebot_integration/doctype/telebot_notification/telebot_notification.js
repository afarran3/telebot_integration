...
frappe.ui.form.on('TeleBot Notification', {
	onload: function(frm) {
		...
		frm.toggle_reqd("telegram_user", !frm.doc.dynamic_recipients ? 1:0);
	},
	...
	event: function(frm) {
		if(in_list(['Days Before', 'Days After'], frm.doc.event)) {
			frm.add_custom_button(__('Get Alerts for Today'), function() {
				frappe.call({
					method: 'telebot_integration.telebot_integration.doctype.telebot_notification.telebot_notification.get_documents_for_today',
					args: {
